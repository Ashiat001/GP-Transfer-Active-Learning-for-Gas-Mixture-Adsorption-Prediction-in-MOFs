...
for i in range(max_iter):
    ...
    err_coll_Kr.append(np.mean(rel_error_Kr))
    
    max_Kr = np.max(rel_error_Kr)
    index_Kr = np.argmax(rel_error_Kr)

    max_coll_Kr.append(max_Kr)
...
for i in data_size_px:
    ...
    for j in range(max_iter):
        ...
        err_coll.append(np.mean(rel_error_Kr_M))
    ...
    no_iters = len(err_coll_Kr_px[i])
    print(no_iters)

    os.system("echo "+str(actual_len)+", "+str(r_squared)+", "+str(MAE)+", "+str(MRE)+", "+str(no_iters)+"  >> Metrics_pure_kr_kr_px.csv")
...
for i in data_size_pxt:
    ...
    for j in range(max_iter):
        ...
        err_coll_pxt.append(np.mean(rel_error_Kr_pxt))
    ...
    err_coll_Kr_pxt[i] = err_coll_pxt
    ...
    no_iters_pxt = len(err_coll_Kr_pxt[i])
    print(no_iters_pxt)

    os.system("echo "+str(actual_len_pxt)+", "+str(r_squared_pxt)+", "+str(MAE_pxt)+", "+str(MRE_pxt)+", "+str(no_iters_pxt)+"  >> Metrics_pure_kr_kr_pxt.csv")