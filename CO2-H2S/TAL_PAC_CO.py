...
data_mix_px = GPR.train_data_generator(df2, 20, 40, 0, 5, 7, 3)
print(data_mix_px.shape)
data_mix_px.to_csv('training_mix_px_co.csv', index = False)

data_mix_pxt = GPR.train_data_generator(df3, 10, 40, 0, 5, 7, 3, 1)
