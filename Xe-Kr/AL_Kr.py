...
b = pd.DataFrame(x_test_pred, columns=['X Test', 'mole fraction'])
c = pd.concat([b, a], axis = 1)
c.to_csv('Pred_AL_Kr.csv',index=False)
...
os.system("echo "+str(r_squared)+", "+str(MAE)+", "+str(MRE)+", "+str(no_iters)+"  >> Metrics_AL_kr.csv")
