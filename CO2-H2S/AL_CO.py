...
c.to_csv('Pred_AL_CO.csv',index=False)
...
f.to_csv('AL_co_sampled_points.csv', index = False)
...
os.system("echo "+str(r_squared)+", "+str(MAE)+", "+str(MRE)+", "+str(no_iters)+"  >> Metrics_AL_co.csv")
